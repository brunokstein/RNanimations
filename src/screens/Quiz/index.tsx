  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.ScrollView
        ...
        // Para o ios, de forma que atualize de uma forma mais rápida os componentes. Evita os saltos no scroll.
...
// NO LUGAR DO gesture={}
//Gesture.Simultaneous(onPan, onLongPress) - simultaneo.
//Gesture.Race(onPan, onLongPress) - se um tiver ativado o outro nao ativa. 